...
*   **Task Details:** Assign importance (star rating) and due dates to your tasks.
...
*   **Import/Export:** Export your task lists to CSV. (Import functionality coming soon).
...
*   **v1.0.0 (Initial Release)**
    ...
    *   Core features: multi-list support, task CRUD, sorting, filtering, themes.
